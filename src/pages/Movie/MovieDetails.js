          ...
          <div class="row justify-content-center">
            <div class="col-sm-11 d-flex">
              ...
              <div>
                ...
                <span class="ratings">
                  <a href="#">
                    <i class="bi bi-star-fill"></i> 8.9/10
                  </a>
                </span>
                <small class="votes">
                  <a href="#">523.3K Votes </a>
                </small>
                <p class="site_text">2D , 4DX 3D , 3D , IMAX 3D , IMAX 2D</p>
                <p class="site_text">
                  English , Hindi , Telugu , Tamil , English (English Subtitle)
                </p>
                <ul class="caption_info d-flex align-items-center">
                  ...
                  <li>
                    {" "}
                    Action , Adventure , Fantasy <i class="bi bi-dot"></i>
                  </li>
                  <li>
                    {" "}
                    UA <i class="bi bi-dot"></i>
                  </li>
                  <li>27 April , 2018</li>
                </ul>
                ...
                <div class="clearfix"></div>
                <span>
                  <a href="" class="btn transparent_btn banner_btn length_big">
                    Watch Movie
                  </a>
                </span>
              </div>
                      ...
                      <div class="single_reviws">
                        <div class="row align-items-center mb-4">
                          ...
                          <div class="col-6 text-end">
                            <span class="ratings">
                              <a href="#">
                                <i class="bi bi-star-fill"></i> 9.2/10
                              </a>
                            </span>
                          </div>
                        </div>
                        ...
                        <p>
                          Epic blockbuster movie I'm shocked fantastic day mind
                          blowing unforgettable memories NYC job actors and
                          direction good photography and cgi work
                        </p>
                        <div class="row align-items-center mb-4">
                          <div class="col-12 col-sm-6">
                            <small class="review_share">
                              <a href="#">
                                <i class="bi bi-hand-thumbs-up"></i> 1.2k
                              </a>
                            </small>
                            <small class="review_share">
                              <a href="#">
                          ...
                          <div class="col-12 col-sm-6 text-end">
                            <small class="review_share">
                              <a href="#">
                                5 Years ago <i class="bi bi-share"></i>
                              </a>
                            </small>
                          </div>
                        </div>
